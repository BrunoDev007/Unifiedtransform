...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de idioma a seguir são as mensagens padrão correspondentes aos
    | motivos informados pelo intermediador de senhas quando uma tentativa de
    | atualização de senha falha, como um token inválido ou uma nova senha inválida.
    |
    */
